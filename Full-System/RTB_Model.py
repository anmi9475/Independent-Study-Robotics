...
class RTB_Model():
    ...
    def __init__(self):
        ...
        self.ur5_DH = rtb.models.DH.UR5()  # standard DH configurations
        self.ur5_URDF = rtb.models.URDF.UR5()  # imports robot def from URDF file
    ...
    def getGripperPose(self):
        ...
        ur5 = self.ur5_DH
        T_N = ur5.G(ur5.q)[-1]  # T_N - end-effector frame (before optoforce/gripper) # .G get/set gear ratio? robot.q is the robot joint configuration
